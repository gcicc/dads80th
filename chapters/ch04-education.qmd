...
It paid off. Vic's desire to stay on the cutting edge of computing planted a seed. His son Greg would take that inheritance to the next level — building a career in biostatistics, computational drug development, and data science. The through line from a business teacher writing grants for Commodore 64s to a Research Fellow building statistical models at AbbVie is straighter than it looks. The father's instinct became the son's profession.
