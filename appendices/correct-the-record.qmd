...
<!-- GREG: Replace YOUR_FORM_ID with the Google Form ID (the long string from the form URL) -->
[Open the Fact-Check Form](https://docs.google.com/forms/d/e/YOUR_FORM_ID/viewform){.btn .btn-primary target="_blank"}
:::
...
*(All three children — full names and birth years. All six grandchildren — names, ages, and which child each belongs to. What do the grandkids call Vic and Yvonne?)*
...
1. **Victor's exact birthday** — we only have "approximately March 1946"
2. **Names of all three children** — we only have Rich confirmed
3. **Names of all six grandchildren** — and which child each belongs to
...
::: {.form-embed}
<!-- GREG: Uncomment the iframe below and replace YOUR_FORM_ID with your Google Form ID -->
<!-- <iframe src="https://docs.google.com/forms/d/e/YOUR_FORM_ID/viewform?embedded=true" width="100%" height="800" frameborder="0" marginheight="0" marginwidth="0">Loading form…</iframe> -->

**The online form is coming soon.** In the meantime, email your corrections to Greg or fill out the printed version.
:::
